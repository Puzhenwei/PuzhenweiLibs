package com.puzhenweilibrary.baseadapter;
...
public class ViewHolder {
	...
	public static ViewHolder get(Context context, View convertView,
		...
		if (convertView == null) {
			Log.i(TAG, "convertView == null, pos: " + position);
	...
	public ViewHolder setText(int viewId, String text) {
		...
		if (!name.equals(text)) {
			tv.setText(text);
			Log.i(TAG,"1111111111--->"+name+"   "+text);
		}
	...
	public ViewHolder setImageDrawable(int viewId, int resId) {
		ImageButton view = getView(viewId);
		Resources res = mContext.getResources();
		view.setImageDrawable(res.getDrawable(resId));
		return this;
	}
