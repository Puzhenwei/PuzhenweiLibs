 ...
 * <p>
 * <p>
 * Remote control <img src="../../../../../../res/drawable/remote_picture.png" />
 * 
 * <pre>
 *  ----------------------------------------------------------------------------------------------------
...
public class RemoteControlListener implements KeyListener, View.OnKeyListener, DialogInterface.OnKeyListener {
    ...
    final KeyEvent event) {
        this.currentView = v;
        return event.getAction() == KeyEvent.ACTION_DOWN ? onKeyDown(keyCode, event) : event.getAction() == KeyEvent.ACTION_UP ? onKeyUp(keyCode, event) : false;
    }
    ...
    @Override
    final public boolean onKeyUp(final int keyCode, @NonNull
    final KeyEvent event) {
    ...
    @Override
    public boolean onKeyDown(final int keyCode, @NonNull
    final KeyEvent event) {
        switch (event.getKeyCode()) {
            case KeyEvent.KEYCODE_MEDIA_REWIND:
    ...
    public String toString() {
        return "RemoteControlListener{" + "currentView=" + currentView + '}';
    }
}
