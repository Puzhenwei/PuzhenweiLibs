 ...
 * <p>
 * <a href="https://developer.amazon.com/appsandservices/solutions/devices/fire-tv/docs/amazon-fire-tv-remote-input">
 * https://developer.amazon.com/appsandservices/solutions/devices/fire-tv/docs/amazon-fire-tv-remote-input</a>
 * <p>
 * 
 * <pre>
 *  ----------------------------------------------------------------------------------------------------
...
public class AmazonFireTvRemoteControlListener implements KeyListener, View.OnKeyListener, DialogInterface.OnKeyListener {
    ...
    @Override
    final public boolean onKey(final View v, final int keyCode, @NonNull
    final KeyEvent event) {
        this.currentView = v;
        return event.getAction() == KeyEvent.ACTION_DOWN ? onKeyDown(keyCode, event) : event.getAction() == KeyEvent.ACTION_UP && onKeyUp(keyCode, event);
    }
    
    @Override
    public boolean onKey(final DialogInterface dialog, final int keyCode, @NonNull
    final KeyEvent event) {
        return event.getAction() == KeyEvent.ACTION_DOWN ? onKeyDown(keyCode, event) : event.getAction() == KeyEvent.ACTION_UP && onKeyUp(keyCode, event);
    }
    ...
    public String toString() {
        return "AmazonFireTvRemoteControlListener{" + "currentView=" + currentView + '}';
    }
}
