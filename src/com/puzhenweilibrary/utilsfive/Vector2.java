...
import com.puzhenweilibrary.utilsfive.MathExtensions;
...
public class Vector2 implements Serializable {
    ...
    /**
     * @return the angle in degrees of this vector (point) relative to the x-axis. Angles are towards the positive
     *         y-axis (typically counter-clockwise) and between 0 and 360.
     */
    public float angle() {
    ...
    /**
     * @return the angle in degrees of this vector (point) relative to the given vector. Angles are towards the positive
     *         y-axis (typically counter-clockwise.) between -180 and +180
     */
    ...
    /**
     * @return the angle in radians of this vector (point) relative to the x-axis. Angles are towards the positive
     *         y-axis. (typically counter-clockwise)
     */
    ...
    /**
     * @return the angle in radians of this vector (point) relative to the given vector. Angles are towards the positive
     *         y-axis. (typically counter-clockwise.)
     */
    ...
    /**
     * Sets the angle of the vector in degrees relative to the x-axis, towards the positive y-axis (typically
     * counter-clockwise).
     *
    ...
    /**
     * Sets the angle of the vector in radians relative to the x-axis, towards the positive y-axis (typically
     * counter-clockwise).
     *
    ...
    /**
     * Rotates the Vector2 by 90 degrees in the specified direction, where >= 0 is counter-clockwise and < 0 is
     * clockwise.
     */
    ...
    public boolean isOnLine(Vector2 other) {
        return MathExtensions.isZero(x * other.y - y * other.x);
    }
    
    public boolean isOnLine(Vector2 other, float epsilon) {
        return MathExtensions.isZero(x * other.y - y * other.x, epsilon);
    }
    ...
    public boolean isPerpendicular(Vector2 vector) {
        return MathExtensions.isZero(dot(vector));
    }
    
    public boolean isPerpendicular(Vector2 vector, float epsilon) {
        return MathExtensions.isZero(dot(vector), epsilon);
    }
