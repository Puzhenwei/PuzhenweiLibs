...
public class Bundler {
    ...
    /**
     * Inserts a Size value into the mapping of this Bundle, replacing any existing value for the given key. Either key
    ...
    /**
     * Inserts a SizeF value into the mapping of this Bundle, replacing any existing value for the given key. Either key
     * or value may be null.
     *
     * @param key a String, or null
    ...
    /**
     * Inserts an array of Parcelable values into the mapping of this Bundle, replacing any existing value for the given
    ...
    /**
     * Inserts a List of Parcelable values into the mapping of this Bundle, replacing any existing value for the given
     * key. Either key or value may be null.
     *
     * @param key a String, or null
    ...
    /**
     * Inserts an ArrayList<Integer> value into the mapping of this Bundle, replacing any existing value for the given
     * key. Either key or value may be null.
     *
     * @param key a String, or null
    ...
    /**
     * Inserts an ArrayList<String> value into the mapping of this Bundle, replacing any existing value for the given
     * key. Either key or value may be null.
     *
     * @param key a String, or null
    ...
    /**
     * Inserts an ArrayList<CharSequence> value into the mapping of this Bundle, replacing any existing value for the
     * given key. Either key or value may be null.
     *
     * @param key a String, or null
    ...
    /**
     * Inserts a CharSequence array value into the mapping of this Bundle, replacing any existing value for the given
     * key. Either key or value may be null.
     *
     * @param key a String, or null
    ...
    /**
     * Inserts a Bundle value into the mapping of this Bundle, replacing any existing value for the given key. Either
     * key or value may be null.
     *
     * @param key a String, or null
    ...
    /**
     * Inserts an {@link IBinder} value into the mapping of this Bundle, replacing any existing value for the given key.
     * Either key or value may be null.
     * <p>
     * <p class="note">
     * You should be very careful when using this function. In many places where Bundles are used (such as inside of
     * Intent objects), the Bundle can live longer inside of another process than the process that had originally
     * created it. In that case, the IBinder you supply here will become invalid when your process goes away, and no
     * longer usable, even if a new process is created for you later on.
     * </p>
     *
     * @param key a String, or null
    ...
    /**
     * Inserts a Boolean value into the mapping of this Bundle, replacing any existing value for the given key. Either
     * key or value may be null.
     *
     * @param key a String, or null
    ...
    /**
     * Inserts a String value into the mapping of this Bundle, replacing any existing value for the given key. Either
     * key or value may be null.
     *
     * @param key a String, or null
