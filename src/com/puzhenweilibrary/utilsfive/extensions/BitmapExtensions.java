...
final public class BitmapExtensions {
    ...
    private BitmapExtensions()
        throws IllegalAccessException {
        throw new IllegalAccessException();
    }
    
    public static Bitmap flipHorizontally(@NonNull
    final Bitmap src) {
    ...
    public static Bitmap flipVertically(@NonNull
    final Bitmap src) {
        final Matrix matrix = new Matrix();
        matrix.preScale(-1.0f, 1.0f);
        return createBitmapWithMatrix(src, matrix);
    ...
    public static Bitmap createBitmapWithMatrix(@NonNull
    final Bitmap src, @NonNull
    final Matrix matrix) {
    ...
    public static Bitmap getBitmap(@NonNull
