...
import static com.puzhenweilibrary.utilsfive.extensions.ByteExtensions.validUTF8;
...
final public class StringExtensions {
    ...
    @NonNull
    public static String clamp(@Nullable
    final String s, final int maxLength) {
        if (isEmpty(s))
            return "";
    ...
    public static String capitalize(final String line) {
        return isEmpty(line) ? "" : Character.toUpperCase(line.charAt(0)) + line.substring(1);
    }
    ...
    public static String encodeBase64(String utf8String) {
        ...
        return isEmpty(utf8) ? "INVALID_UTF-8" : utf8;
    }
