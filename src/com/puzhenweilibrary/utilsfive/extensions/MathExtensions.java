...
import com.puzhenweilibrary.utilsfive.misc.RandomXS128;
...
final public class MathExtensions {
     ...
     * <p>
     * This method is equivalent of {@link #randomTriangular(float, float, float) randomTriangular(min, max, (min + max)
     * * .5f)}
     *
    ...
    /**
     * Linearly interpolates between two angles in radians. Takes into account that angles wrap at two pi and always
