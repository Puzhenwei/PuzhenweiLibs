...
final public class SpannableExtensions {
    ...
    @NonNull
    public static Spannable colorize(@NonNull
    final Spannable spannable, @ColorRes
    final int color) {
    ...
    @NonNull
    public static Spannable strikeThrough(@NonNull
    ...
    @NonNull
    public static Spannable bold(@NonNull
    final Spannable spannable) {
    ...
    @NonNull
    public static Spannable boldItalic(@NonNull
    final Spannable spannable) {
        final SpannableString result = new SpannableString(spannable);
