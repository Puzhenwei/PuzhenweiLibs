...
public class RandomXS128 extends Random {
    ...
    private static final long serialVersionUID = -2623880356035800049L;
    ...
    /**
     * Returns a pseudo-random, uniformly distributed {@code double} value between 0.0 and 1.0 from this random number
     ...
     * <p>
     * The given seed is passed twice through a hash function. This way, if the user passes a small value we avoid the
