 ...
 * and the two argument constructor {@link java.io.File#File(java.io.File, String) File(File,String)}.
 * <p>
...
public class FilenameUtils {
     ...
     * removed. If the double dot has no parent path segment to work with, {@code null} is returned.
     * <p>
     ...
     * <p>
     * This method normalizes a path to a standard format. The input may contain separators in either Unix or Windows
     * format. The output will contain separators in the format specified.
     * <p>
     * A trailing slash will be retained. A double slash will be merged to a single slash (but UNC names are handled). A
     * single dot path segment will be removed. A double dot will cause that path segment and the one before to be
     * removed. If the double dot has no parent path segment to work with, {@code null} is returned.
     ...
     *
     * @param filename the filename to normalize, null returns null
     * @param unixSeparator {@code true} if a unix separator should be used or {@code false} if a windows separator
     *            should be used.
     * @return the normalized filename, or null if invalid
     * @since 2.0
     */
     ...
     *
     * @param filename the filename to normalize, null returns null
     * @param unixSeparator {@code true} if a unix separator should be used or {@code false} if a windows separtor
     *            should be used.
     * @return the normalized filename, or null if invalid
     * @since 2.0
     */
