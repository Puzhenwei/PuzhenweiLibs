 ...
 */
package com.puzhenweilibrary.utilsfour;
...
public class FileUtils {
    ...
    /**
     * Opens a {@link java.io.FileInputStream} for the specified file, providing better error messages than simply
     * calling <code>new FileInputStream(file)</code>.
     * <p/>
    ...
    /**
     * Opens a {@link java.io.FileOutputStream} for the specified file, checking and creating the parent directory if it
     * does not exist.
     * <p/>
     * At the end of the method either the stream will be successfully opened, or an exception will have been thrown.
     * <p/>
     ...
     * <p/>
     * NOTE: As from v1.3, this method throws an IOException if the last modified date of the file cannot be set. Also,
    ...
    /**
     * Converts a Collection containing java.io.File instanced into array representation. This is to account for the
     * difference between File.listFiles() and FileUtils.listFiles().
     *
     ...
     * Compares the contents of two files to determine if they are equal or not.
     * <p/>
     * This method checks to see if the two files point to the same file, before resorting to line-by-line comparison of
     * the contents.
     * <p/>
     *
     * @param file1 the first file
     ...
     * correctly decoded to <code>/my docs/file.txt</code>. Starting with version 1.5, this method uses UTF-8 to decode
     * percent-encoded octets to characters. Additionally, malformed percent-encoded octets are handled leniently by
     ...
     * <p/>
     * Returns an array of the same size as the input. If the input is {@code null}, an empty array is returned. If the
     * input contains {@code null}, the output array contains {@code null} at the same index.
     * <p/>
     * This method will decode the URL. Syntax such as <code>file:///my%20docs/file.txt</code> will be correctly decoded
     * to <code>/my docs/file.txt</code>.
     *
     * @param urls the file URLs to convert, {@code null} returns empty array
     * @return a non-{@code null} array of Files matching the input, with a {@code null} item if there was a
     *         {@code null} at that index in the input array
     ...
     * {@link java.io.File#setLastModified(long)}, however it is not guaranteed that the operation will succeed. If the
     ...
     * modified date/times using {@link java.io.File#setLastModified(long)}, however it is not guaranteed that the
     ...
     * {@link java.io.File#setLastModified(long)}, however it is not guaranteed that those operations will succeed. If
     * the modification operation fails, no indication is provided.
     *
     ...
     * modified date/times using {@link java.io.File#setLastModified(long)}, however it is not guaranteed that those
     * operations will succeed. If the modification operation fails, no indication is provided.
     *
     * @param srcDir an existing directory to copy, must not be {@code null}
     * @param destDir the new directory, must not be {@code null}
     * @param preserveFileDate true if the file date of the copy should be the same as the original
     ...
     * <p/>
     * Warning: this method does not set a connection or read timeout and thus might block forever. Use
     * {@link #copyURLToFile(java.net.URL, java.io.File, int, int)} with reasonable timeouts to prevent this.
     *
     ...
     * @param destination the non-directory <code>File</code> to write bytes to (possibly overwriting), must not be
     *            {@code null}
     * @param connectionTimeout the number of milliseconds until this method will timeout if no connection could be
     *            established to the <code>source</code>
    ...
    /**
     * Copies bytes from an {@link java.io.InputStream} <code>source</code> to a file <code>destination</code>. The
     ...
     * <p/>
     * This method repeatedly tests {@link java.io.File#exists()} until it returns true up to the maximum time specified
     * in seconds.
     *
     ...
     *             {@link java.io.UnsupportedEncodingException} in version 2.2 if the encoding is not supported.
     * @since 2.3
     */
     ...
     * @throws java.io.IOException in case of an I/O error
     * @throws java.nio.charset.UnsupportedCharsetException thrown instead of
     *             {@link java.io.UnsupportedEncodingException} in version 2.2 if the encoding is not supported by the
     *             VM
     * @since 2.1
     */
    ...
    /**
     * Writes the <code>toString()</code> value of each item in a collection to the specified <code>File</code> line by
     * line. The specified character encoding and the default line ending will be used.
     * <p/>
     * NOTE: As from v1.3, the parent directories of the file will be created if they do not exist.
     *
     * @param file the file to write to
    ...
    /**
     * Writes the <code>toString()</code> value of each item in a collection to the specified <code>File</code> line by
     * line, optionally appending. The specified character encoding and the default line ending will be used.
     *
     * @param file the file to write to
     * @param encoding the encoding to use, {@code null} means platform default
     * @param lines the lines to write, {@code null} entries produce blank lines
    ...
    /**
     * Writes the <code>toString()</code> value of each item in a collection to the specified <code>File</code> line by
     * line. The default VM encoding and the default line ending will be used.
     *
     * @param file the file to write to
     * @param lines the lines to write, {@code null} entries produce blank lines
     * @throws java.io.IOException in case of an I/O error
    ...
    /**
     * Writes the <code>toString()</code> value of each item in a collection to the specified <code>File</code> line by
     * line. The specified character encoding and the line ending will be used.
     * <p/>
     * NOTE: As from v1.3, the parent directories of the file will be created if they do not exist.
     *
     * @param file the file to write to
    ...
    /**
     * Writes the <code>toString()</code> value of each item in a collection to the specified <code>File</code> line by
     * line. The default VM encoding and the specified line ending will be used.
     *
     * @param file the file to write to
     * @param lines the lines to write, {@code null} entries produce blank lines
     * @param lineEnding the line separator to use, {@code null} is system default
    ...
    /**
     * Returns the size of the specified file or directory. If the provided {@link java.io.File} is a regular file, then
     * the file's length is returned. If the argument is a directory, then the size of the directory is calculated
     ...
     *
     * @param file the <code>File</code> of which the modification date must be compared, must not be {@code null}
     * @param reference the <code>File</code> of which the modification date is used, must not be {@code null}
     * @return true if the <code>File</code> exists and has been modified more recently than the reference
     *         <code>File</code>
