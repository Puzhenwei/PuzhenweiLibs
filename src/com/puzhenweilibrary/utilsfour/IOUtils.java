...
import com.puzhenweilibrary.utilsfour.stream.StringBuilderWriter;
 ...
 * <code>BufferedInputStream</code> or <code>BufferedReader</code>. The default buffer size of 4K has been shown to be
 * efficient in tests.
 * <p/>
...
public class IOUtils {
    ...
    /**
     * The default buffer size ({@value} ) to use for {@link #copyLarge(java.io.InputStream, java.io.OutputStream)} and
    ...
    /*
     * N.B. no need to synchronize these because: - we don't care if the buffer is created multiple times (the data is
     ...
     * <p/>
     * Equivalent to {@link java.io.Reader#close()}, except any exceptions will be ignored. This is typically used in
     * finally blocks.
     * <p/>
     * Example code:
     * 
     ...
     * <p/>
     * Equivalent to {@link java.io.Writer#close()}, except any exceptions will be ignored. This is typically used in
     * finally blocks.
     * <p/>
     * Example code:
     * 
     ...
     * <p/>
     * Equivalent to {@link java.io.InputStream#close()}, except any exceptions will be ignored. This is typically used
     * in finally blocks.
     * <p/>
     * Example code:
     * 
     ...
     * <p/>
     * Equivalent to {@link java.io.OutputStream#close()}, except any exceptions will be ignored. This is typically used
     * in finally blocks.
     * <p/>
     * Example code:
     * 
     ...
     * <p/>
     * Equivalent to {@link java.io.Closeable#close()}, except any exceptions will be ignored. This is typically used in
     * finally blocks.
     * <p/>
     * Example code:
     * 
     ...
     * <p/>
     * Equivalent to {@link java.net.Socket#close()}, except any exceptions will be ignored. This is typically used in
     * finally blocks.
     * <p/>
     * Example code:
     * 
     ...
     * <p/>
     * Equivalent to {@link java.nio.channels.Selector#close()}, except any exceptions will be ignored. This is
     ...
     * <p/>
     * Equivalent to {@link java.net.ServerSocket#close()}, except any exceptions will be ignored. This is typically
     ...
     * </ul>
     * It can be used in favor of {@link #toByteArray(java.io.InputStream)}, since it avoids unnecessary allocation and
     * copy of byte[].<br>
    ...
    public static InputStream toBufferedInputStream(InputStream input)
        throws IOException {
        return com.puzhenweilibrary.utilsfour.stream.ByteArrayOutputStream.toBufferedInputStream(input);
    }
    
    /**
     * Returns the given reader if it is a {@link java.io.BufferedReader}, otherwise creates a toBufferedReader for the
     * given reader.
     *
    ...
    public static byte[] toByteArray(InputStream input)
        throws IOException {
        com.puzhenweilibrary.utilsfour.stream.ByteArrayOutputStream output = new com.puzhenweilibrary.utilsfour.stream.ByteArrayOutputStream();
        copy(input, output);
     ...
     * {@link com.litesuits.common.io.IOUtils#toByteArray(java.io.InputStream, int)} to read into the byte array.
    ...
    /**
     * Get the contents of a <code>Reader</code> as a <code>byte[]</code> using the default character encoding of the
     * platform.
     * <p/>
    ...
    /**
     * Copy some or all bytes from a large (over 2GB) <code>InputStream</code> to an <code>OutputStream</code>,
    ...
    /**
     * Copy some or all chars from a large (over 2GB) <code>InputStream</code> to an <code>OutputStream</code>,
    ...
    /**
     * Skip bytes from an input byte stream. This implementation guarantees that it will read as many bytes as possible
     * before giving up; this may not always be the case for subclasses of {@link java.io.Reader}.
     *
    ...
    /**
     * Skip characters from an input character stream. This implementation guarantees that it will read as many
     * characters as possible before giving up; this may not always be the case for subclasses of {@link java.io.Reader}
     * .
     *
     ...
     * <p/>
     * This allows for the possibility that {@link java.io.InputStream#skip(long)} may not skip as many bytes as
     ...
     * <p/>
     * This allows for the possibility that {@link java.io.Reader#skip(long)} may not skip as many characters as
     * requested (most likely because of reaching EOF).
     *
     * @param input stream to skip
     ...
     * before giving up; this may not always be the case for subclasses of {@link java.io.InputStream}.
     *
     * @param input where to read input from
     * @param buffer destination
     * @param offset inital offset into buffer
     ...
     * <p/>
     * This allows for the possibility that {@link java.io.Reader#read(char[], int, int)} may not read as many
     ...
     * <p/>
     * This allows for the possibility that {@link java.io.InputStream#read(byte[], int, int)} may not read as many
