 ...
 * <br>
 * <b>1、Object相关验证</b> <br>
 * &nbsp;&nbsp;&nbsp;&nbsp;(1.01)、验证对象是否为空，为空的话抛出异常：static void valiObjectIsNull(Object object, String objectName) <br>
 * <br>
 * <b>2、String相关验证</b> <br>
 * &nbsp;&nbsp;&nbsp;&nbsp;(2.01)、验证字符串的长度是在指定范围内，不在的话抛出异常，忽略前后的空白符：static void valiStringLength(String string, int
 * minLength, int maxLength) <br>
 * &nbsp;&nbsp;&nbsp;&nbsp;(2.02)、验证字符串的长度的最小值，不合法的话抛出异常，忽略前后的空白符：static void valiStringMinLength(String string, int
 * minLength) <br>
 * &nbsp;&nbsp;&nbsp;&nbsp;(2.03)、验证字符串的长度的最大值，不合法的话抛出异常，忽略前后的空白符：static void valiStringMaxLength(String string, int
 * maxLength) <br>
 * <br>
 * <b>3、int相关验证</b> <br>
 * &nbsp;&nbsp;&nbsp;&nbsp;(3.01)、验证Int型数据是在指定范围内，不在的话抛出异常：static valiIntValue(int number, int minValue, int maxValue,
 * String objectName) <br>
 * &nbsp;&nbsp;&nbsp;&nbsp;(3.02)、验证Int数据的最小值，不合法的话抛出异常：static void valiIntMinValue(int number, int minValue, String
 * objectName) <br>
 * &nbsp;&nbsp;&nbsp;&nbsp;(3.03)、验证Int数据的最大值，不合法的话抛出异常：static void valiIntMaxValue(int number, int maxValue, String
 * objectName) <br>
 * <br>
 * <b>4、File相关验证</b> <br>
 * &nbsp;&nbsp;&nbsp;&nbsp;(4.01)、验证文件是否存在，不存在的话抛出异常：static valiFileIsExists(File file) <br>
 * &nbsp;&nbsp;&nbsp;&nbsp;(4.02)、验证文件是否能读取，不能读的话抛出异常：static void valiFileCanRead(File file) <br>
 * &nbsp;&nbsp;&nbsp;&nbsp;(4.03)、验证文件是否能写入，不能写的话抛出异常：static void valiFileCanWrite(File file) <br>
 * &nbsp;&nbsp;&nbsp;&nbsp;(4.04)、验证file是否是目录，不是的话抛出异常：static void valiFileIsDirectory(File directory) <br>
 * &nbsp;&nbsp;&nbsp;&nbsp;(4.05)、验证file是否是文件，不是的话抛出异常：static void valiFileIsFile(File file) <br>
 * &nbsp;&nbsp;&nbsp;&nbsp;(4.06)、对指定的文件对象进行是否null、是否存在以及是否是文件校验，不合法的话抛出异常：static void valiFile(File file) <br>
 * &nbsp;&nbsp;&nbsp;&nbsp;(4.07)、用于在执行读取之前对指定的文件对象进行是否null、是否存在、是否是文件以及能否读取校验，不合法的话抛出异常：static void
 * valiFileByReadBefore(File file) <br>
 * &nbsp;&nbsp;&nbsp;&nbsp;(4.08)、用于在执行写入之前对指定的文件对象进行是否null、是否存在、是否是文件以及能否写入校验，不合法的话抛出异常：static void
 * valiFileByWriteBefore(File file)
 */
public class CheckingUtils {
     ...
     */
    public static void valiObjectIsNull(Object object, String objectName)
     ...
     */
    public static void valiStringLength(String string, int minLength, int maxLength)
     ...
     */
    public static void valiStringMinLength(String string, int minLength)
        throws IllegalArgumentException {
        int length = string.trim().length();
        if (!(length >= minLength)) {
            throw new IllegalArgumentException("String '" + string + "' length illegal!");
     ...
     */
    public static void valiStringMaxLength(String string, int maxLength)
        throws IllegalArgumentException {
        int length = string.trim().length();
        if (!(length <= maxLength)) {
            throw new IllegalArgumentException("String '" + string + "' length illegal!");
     ...
     */
    public static void valiIntValue(int number, int minValue, int maxValue, String objectName)
        throws IllegalArgumentException {
     ...
     */
    public static void valiIntMinValue(int number, int minValue, String objectName)
        throws IllegalArgumentException {
        if (!(number >= minValue)) {
            throw new IllegalArgumentException("Int object '" + objectName + "' is illegal!");
        }
     ...
     */
    public static void valiIntMaxValue(int number, int maxValue, String objectName)
        throws IllegalArgumentException {
        if (!(number <= maxValue)) {
            throw new IllegalArgumentException("Int object '" + objectName + "' is illegal!");
        }
     ...
     * @throws IllegalArgumentException number的值不在minLength到maxLength之间时抛出此异常
     */
    public static void valiLongValue(long number, long minValue, long maxValue, String objectName)
        throws IllegalArgumentException {
        if (!((number >= minValue) && (number <= maxValue))) {
     ...
     * @throws IllegalArgumentException number的值小于minLength时抛出此异常
     */
    public static void valiLongMinValue(long number, long minValue, String objectName)
        throws IllegalArgumentException {
        if (!(number >= minValue)) {
            throw new IllegalArgumentException("Long object '" + objectName + "' is illegal!");
        }
     ...
     * @throws IllegalArgumentException number的值大于maxLength时抛出此异常
     */
    public static void valiLongMaxValue(long number, long maxValue, String objectName)
        throws IllegalArgumentException {
        if (!(number <= maxValue)) {
            throw new IllegalArgumentException("Long object '" + objectName + "' is illegal!");
        }
     ...
     */
    public static void valiFileIsExists(File file)
     ...
     */
    public static void valiFileCanRead(File file)
        throws IOException {
        if (!file.canRead()) {
     ...
     */
    public static void valiFileCanWrite(File file)
        throws IOException {
        if (!file.canWrite()) {
     ...
     */
    public static void valiFileIsDirectory(File file)
        throws IllegalArgumentException {
        if (!file.isDirectory()) {
     ...
     */
    public static void valiFileIsFile(File file)
        throws IllegalArgumentException {
        if (!file.isFile()) {
    ...
    /**
     * (4.06)、对指定的文件对象进行是否null、是否存在以及是否是文件校验，不合法的话抛出 NullPointerException, FileNotFoundException,
     ...
     */
    public static void valiFile(File file)
    ...
    /**
     * (4.06)、对指定的文件对象进行是否null、是否存在以及是否是目录校验，不合法的话抛出 NullPointerException, FileNotFoundException,
     * IllegalArgumentException异常
     * 
     * @param file 指定的文件
     * @throws java.io.FileNotFoundException 找不到file代表的文件
     * @throws IllegalArgumentException file不是文件
     */
    public static void valiDir(File file)
        throws NullPointerException, FileNotFoundException, IllegalArgumentException {
        valiObjectIsNull(file, "file");
        valiFileIsExists(file);
     ...
     */
    public static void valiFileByReadBefore(File file)
        throws NullPointerException, FileNotFoundException, IllegalArgumentException, IOException {
        valiFile(file);
     ...
     */
    public static void valiFileByWriteBefore(File file)
        throws IOException {
        valiFile(file);
