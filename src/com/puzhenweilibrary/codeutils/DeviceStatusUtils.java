...
public class DeviceStatusUtils {
     ...
     *
     * @param context 上下文
     * @return System.SCREEN_BRIGHTNESS_MODE_AUTOMATIC：自动；System. SCREEN_BRIGHTNESS_MODE_AUTOMATIC
    ...
    public static void setRingVolume(Context context, int ringVloume) {
        ...
        ((AudioManager)context.getSystemService(Context.AUDIO_SERVICE)).setStreamVolume(AudioManager.STREAM_RING, ringVloume, AudioManager.FLAG_PLAY_SOUND);
    }
