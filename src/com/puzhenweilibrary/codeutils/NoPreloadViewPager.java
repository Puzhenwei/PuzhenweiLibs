...
/**
 * 作者：Administrator on 2016/9/26 09:53 邮箱：906514731@qq.com 禁止预加载的vbiewpager
 */
public class NoPreloadViewPager extends ViewGroup {
    ...
    public interface OnPageChangeListener {
         ...
         *
         * @param position Position index of the first page currently being displayed. Page position+1 will be visible
    ...
    /**
     * Set the currently selected page. If the ViewPager has already been through its first layout there will be a
     * smooth animated transition between the current item and the specified item.
     *
    ...
    /**
     * Returns the number of pages that will be retained to either side of the current page in the view hierarchy in an
     * idle state. Defaults to 1.
     *
    ...
    /**
     * Set the number of pages that should be retained to either side of the current page in the view hierarchy in an
     * idle state. Pages beyond this limit will be recreated from the adapter when needed.
     *
     * <p>
     * This is offered as an optimization. If you know in advance the number of pages you will need to support or have
     * lazy-loading mechanisms in place on your pages, tweaking this setting can have benefits in perceived smoothness
     * of paging animations and interaction. If you have a small number of pages (3-4) that you can keep active all at
     * once, less time will be spent in layout for newly created view subtrees as the user pages back and forth.
     * </p>
     *
     * <p>
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        ...
        switch (action) {
            case MotionEvent.ACTION_MOVE: {
                ...
                final boolean atEdge = (dx > 0 && scrollX == 0) || (dx < 0 && mAdapter != null && scrollX >= (mAdapter.getCount() - 1) * getWidth() - 1);
                if (DEBUG)
