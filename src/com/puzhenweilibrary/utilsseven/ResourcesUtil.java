...
public class ResourcesUtil {
    ...
    public static int getColor(@ColorRes int colorRes, Resources.Theme theme) {
        /*
         * if (APILevel.require(23)) return Base.getResources().getColor(colorRes, theme); else
         */
    ...
    public static ColorStateList getColorStateList(@ColorRes int colorRes, Resources.Theme theme) {
        /*
         * if (APILevel.require(23)) return Base.getResources().getColorStateList(colorRes, theme); else
         */
