...
public class Strings {
    ...
    /**
     * Convenience method for adding quotes. The specified object is converted to a string representation by calling its
     ...
     * @return an escaped representation of the specified string
     */
     ...
     * @return a string representation of the specified string with escaped characters replaced with their original form
     */
    ...
    /**
     * Wraps <code>java.lang.String.valueOf()</code> to return an empty string where the specified object is null.
     *
    ...
    /**
     * Reemplaza todas las apariciones en un string (source) de los elementos de un array de strings (target) con un
     * string de reemplazo (replace)
     *
     * @param source
     * @param target
     * @param replace
    ...
    public static String replace(String source, String[] target, String replace) {
        for (String s : target) {
            source = source.replace(s, replace).trim();
        }
        return source;
    }
    ...
    /**
     * Reemplaza todas las apariciones en un string (source) de los elementos de un array de strings (target) con un
     * array de string de reemplazo (replaces) que debe ser igual que target
     *
     * @param source
     * @param target
     * @param replaces
     * @return String
     */
    public static String replace(String source, String[] target, String[] replaces) {
        int pos = 0;
        for (String s : target) {
            source = source.replace(s, replaces[pos]).trim();
            pos++;
        }
        return source;
    }
    ...
    public static String replaceHTMLCodes(String in) {
        String[] buenas = {"Á", "á", "É", "é", "Í", "í", "Ó", "ó", "Ú", "ú", "Ñ", "ñ", "Ü", "ü", "«", "»", "¿", "¡", "€", " ", "..."};
        String[] catalans = {"à", "è", "ì", "ò", "ù", "À", "È", "Ì", "Ò", "Ù", "ç", "Ç", "·", "...", "–"};
        String[] not_catalans = {"&#xe0;", "&#xe8;", "&#xec;", "&#xf2;", "&#xf9;", "&#xc0;", "&#xc8;", "&#xcc;", "&#xd2;", "&#xd9;", "&#xe7;", "&#xc7;", "&#xb7;", "&#x2026;", "&#x2013;"};
        
        String[] not1 = {"&#193;", "&#225;", "&#201;", "&#233;", "&#205;", "&#237;", "&#211;", "&#243;", "&#218;", "&#250;", "&#209;", "&#241;", "&#220;", "&#252;", "&#171;", "&#187;", "&#191;", "&#161;", "&#128;", " ", "..."};
        String[] not2 = {"&#xc4;", "&#xe1;", "&#xc9;", "&#xe9;", "&#xcd;", "&#xed;", "&#xd3;", "&#xf3;", "&#xda;", "&#xfa;", "&#xd1;", "&#xf1;", "&#xdc;", "&#xfc;", "&#xab;", "&#xbb;", "&#xbf;", "&#xa1;", "&#x80;", "&#xA0;", "..."};
        String[] not3 = {"&Aacute;", "&aacute;", "&Eacute;", "&eacute;", "&Iacute;", "&iacute;", "&Oacute;", "&oacute;", "&Uacute;", "&uacute;", "&Ntilde;", "&ntilde;", "&Uuml;", "&uuml;", "&laquo;", "&raquo;", "&iquest;", "&iexcl;", "&euro;", " ", "&hellip;"};
